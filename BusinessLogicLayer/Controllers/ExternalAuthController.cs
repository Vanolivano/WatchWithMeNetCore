...
namespace BusinessLogicLayer.Controllers
{
  ...
  public class ExternalAuthController : Controller
  {
    ...
    public ExternalAuthController(IOptions<FacebookAuthSettings> fbAuthSettingsAccessor, UserManager<AppUser> userManager, DatabaseContext appDbContext, IJwtFactory jwtFactory, IOptions<JwtIssuerOptions> jwtOptions)
    {
